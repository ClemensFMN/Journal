...
It seems to be the typical case that about half the numbers below $p$ are quadratic residues, the other half being quadratic nonresidues. \todo{Cross-check with Python scipt and include plot} For $p$ being an odd prime, $(p+1)/2$ integers are quadratic integers.
