...
We can do the same in GAP: We first define the identity element in the ``modulo-space''; then we can perform calculations with it. In the example below, we first calculate the inverse of $4$ modulo-$17$ and then solve $4x \equiv 2 \mod 7$. \todo{Something's broken 7 vs 17?!}
...
\bee
35x_1 \equiv 1 \mod 3, \quad 21x_2 \equiv 1 \mod 5, \quad 15x_3 \equiv 1 \mod 7
\eee
