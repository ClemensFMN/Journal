...
We can now divide both sides by $9$ \todo{what happens if we cannot divide; e.g. how do we solve $5 x \equiv 9 \mod 13$} and finally arrive at

\bee
\ind_2 x \equiv 1 \mod 4 \todo{why does the mod change??}
\eee
