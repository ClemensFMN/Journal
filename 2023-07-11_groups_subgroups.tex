...
\paragraph{The Quaternois $SU_2(\mC)$.} Let's see which matrices are in this group. We start with
...
\bee
A^{-1} = \frac{1}{\det(A)} \begin{pmatrix} \delta & -\beta \\ -\gamma & \alpha \end{pmatrix} = \begin{pmatrix} \delta & -\beta \\ -\gamma & \alpha \end{pmatrix}
\eee
