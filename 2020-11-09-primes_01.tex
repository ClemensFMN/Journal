...
Every Euclidean number is congruent to $3 \mod 4$ since the primorial of which it is composed is twice the product of only odd primes and thus congruent to $2 \mod 4$. This property implies that no Euclid number can be a square. \todo{proof?}
