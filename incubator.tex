...
\bee
\lambda \Abf \pbf_1 + (1-\lambda) \Abf \pbf_2 \leq \lambda \bbf + (1-\lambda) \bbf = \bbf
\eee

To summarize, the points between $\pbf_1$ and $\pbf_2$, namely $\lambda \pbf_1 + (1-\lambda) \pbf_2, \lambda \in [0,1]$  are located in the convex region. \qed
