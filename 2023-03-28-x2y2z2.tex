...
\todo{Include some stuff from Wikipedia}
...
which is not possible \todo{why mod 4??}. Therefore, $s$ must be an odd integer and $t$ an even integer. So we can write $t = 2r$ and $x_0^2 = 2st$ becomes $x_0^2 = 4sr$ which we can rewrite as
