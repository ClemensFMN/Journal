...
As example, the permutation $\sigma = (1,2,3)(5,8)$ has one cycle of even length, so $\epsilon(\sigma) = -1$, whereas the permuation $\tau = (1,2)(3,4)(6,7,8)$ has two cycles of even length and therefore $\epsilon(\tau) = 1$. \todo{cross-check with gap}
