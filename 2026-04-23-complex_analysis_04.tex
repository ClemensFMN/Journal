...
This result matches the results obtained before (as expected, as $f(z)$ is an analytical function). I have included the Maxima commands below (interestingly, Maxima does not allow complex integration bounds; so i integrate and use \verb+ subst + to obtain the integral value).
